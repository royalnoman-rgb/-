      ...
      <section className="max-w-7xl mx-auto w-full px-4 md:px-6 pb-10 text-[#434338]">
        <div className="bg-white p-6 md:p-8 rounded-[24px] border border-[#DCDCCF] shadow-sm">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2 text-sm md:text-base">
            ...
            <li><strong>৬টি ভিন্নধর্মী ডিজাইন টেমপ্লেট:</strong> সাধারণ, ব্রেকিং নিউজ এবং স্পেশাল খবরের জন্য সর্বমোট ৬টি আলাদা প্রফেশনাল ডিজাইন টেমপ্লেট রয়েছে। <br/><span className="text-red-600 font-medium">*নোট: এর মধ্যে "ডিজাইন ১" শুধুমাত্র পূর্বধলার দর্পন কর্তৃপক্ষের (অ্যাডমিন) ব্যবহারের জন্য সংরক্ষিত এবং পাসওয়ার্ড দ্বারা সুরক্ষিত রাখা হয়েছে। বাকি ৫টি ডিজাইন সম্পূর্ণ বিনামূল্যে যে কেউ ব্যবহার করতে পারবেন।</span></li>
          ...
          <ol className="list-decimal pl-6 mb-4 space-y-2 text-sm md:text-base">
            ...
            <li>ফটোকার্ড মেকার থেকে আপনার খবরের ধরন অনুযায়ী ২ থেকে ৬ এর মধ্যে যেকোনো একটি <strong>ডিজাইন টেমপ্লেট</strong> নির্বাচন করুন।</li>
